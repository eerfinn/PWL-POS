{{-- filepath: c:\laragon\www\PWL_POS\resources\views\level\index.blade.php --}}
        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('/level/export_excel') }}" class="btn btn-primary"><i class="fa fa-file-excel"></i> Export
                    Level (excel)</a>
                <a href="{{ url('/level/export_pdf') }}" class="btn btn-warning" target="_blank"><i class="fa fa-file-pdf"></i> Export Level (pdf)</a>
