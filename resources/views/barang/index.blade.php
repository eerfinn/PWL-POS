        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('/barang/export_excel') }}" class="btn btn-primary"><i class="fa fa-file-excel"></i> Export
                    Barang (excel)</a>
                <a href="{{ url('/barang/export_pdf') }}" class="btn btn-warning" target="_blank"><i class="fa fa-file-pdf"></i> Export
                    Barang (pdf)</a>
        ...
        $(document).ready(function() {
            tableBarang = $('#table-barang').DataTable({
                ...
                ajax: {
                    ...
                    dataType: "json",
                    data: function(d) {
                        d.filter_kategori = $('.filter_kategori').val(); // Kirim nilai filter kategori
                    }
                },
                columns: [{
                    data: "DT_RowIndex",
