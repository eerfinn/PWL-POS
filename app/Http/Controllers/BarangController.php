...
class BarangController extends Controller
{
    ...
    {
        $barang = BarangModel::select('m_barang.barang_id', 'm_barang.kategori_id', 'm_barang.barang_kode', 'm_barang.barang_nama', 'm_barang.harga_beli', 'm_barang.harga_jual', 'm_kategori.kategori_nama')
